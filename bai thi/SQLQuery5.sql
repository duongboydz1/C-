...
('ChipSPD,Clock,Memory Bank','ABC','SPD means Serial Presence Detection,SDRAM operation is synchronized with the signal clock,This is the section that contains the memory modules - cells - that store information.',$500,3,12,'Ram.png')
insert into Parts(PartName,CateID,Description,Price,Quantity,Warranty,Photo)Values
('Logic ALU,','Perform arithmetic and logic calculations,stores parameters for the ALU to calculate and store the returned results',$600,1,24,'Cpu.png')
insert into Parts(PartName,CateID,Description,Price,Quantity,Warranty,Photo)Values
('Magnetic disk,Printed Circuit Board','The magnetic disk is an important place in the hard drive because the data is stored on it,This is the main source to supply power to all the components inside the hard drive',$800,2,6,'Hdd.png')
go
select * from Parts
go
drop table Parts
...
('ChipSPD,Clock,Memory Bank','ABC','SPD means Serial Presence Detection,SDRAM operation is synchronized with the signal clock,This is the section that contains the memory modules - cells - that store information.',$500,3,12,'Ram.png')
insert into Parts(PartName,CateID,Description,Price,Quantity,Warranty,Photo)Values
('Logic ALU,','DEF','Perform arithmetic and logic calculations,stores parameters for the ALU to calculate and store the returned results',$600,1,24,'Cpu.png')
insert into Parts(PartName,CateID,Description,Price,Quantity,Warranty,Photo)Values
('Magnetic disk,Printed Circuit Board','GHI','The magnetic disk is an important place in the hard drive because the data is stored on it,This is the main source to supply power to all the components inside the hard drive',$800,2,6,'Hdd.png')
go
select * from Parts
go
drop table Parts
...
insert into Parts(PartName,CateID,Description,Price,Quantity,Warranty,Photo)Values
('Magnetic disk,Printed Circuit Board','GHI','The magnetic disk is an important place in the hard drive ',$800,2,6,'Hdd.png')
go
select * from Parts
go
drop table Parts
